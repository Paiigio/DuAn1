...
public class CTSanPham {
    ...
    public CTSanPham(String id, MauSac ms, CTKhuyenMai ctkm, SanPham sp, DungLuong dl, String ma, String maQR, int soLuongTon, String hinhAnh, int namBH, float giaNhap, float giaBan, Date ngayTao, Date ngayNhap) {
        this.id = id;
        this.ms = ms;
        this.ctkm = ctkm;
        this.sp = sp;
